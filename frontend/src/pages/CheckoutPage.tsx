                            ...
                            <div className="bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.03)]">
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {(selectedGateway === 'stripe' || selectedGateway === 'cardlink') && (
                                            <motion.div
                                            ...
                                            >
                                                ...
                                                <span className="text-blue-600 font-black">
                                                    +{invoice.currency} {(invoice.amount * 0.3).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                                                </span>
                                            </motion.div>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex justify-between items-end">
                                        <div>
                                            ...
                                            <p className="text-5xl font-black text-slate-900 mt-1 leading-none tracking-tighter">
                                                {invoice.currency} {((selectedGateway === 'stripe' || selectedGateway === 'cardlink') ? invoice.amount * 1.3 : invoice.amount).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                                            </p>
                                        </div>
